...
![uusi_taitto_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image22.png)
Ensimmäisenä kysytään uuden taiton nimeä. Anna taitolle jokin sitä hyvin kuvaava nimi. Taittoa varten avautuu uusi ikkuna.
![uusi_taitto_ikkuna_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image9.png)
...
![karttanakyma_tuloste_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image1.png)
Vedä tulosalueelle suorakulmio, karttanäkymän mukainen kartta piirtyy näytölle.
![karttanakyma_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image2.png)
...
![valitse_siirra_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image16.png)
Valitse/siirrä elementtiä.


![siirra_sisaltoa_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image21.png)
Siirrä elementin sisältöä (esimerkiksi kartan sisältöä).


![zoomaa_taiton_nakymassa_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/19)
...
![lisaa_uusi_nimio_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image7,png)
Lisää uusi selite käyttäen: 
![lisaa_uusi_selite_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image8.png)
Ja lisää uusi mittakaava käyttäen: 
![lisaa_uusi_mittakaava_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image20.png)
...
![tekstinmuokkaus_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image25.png)
...
![phjoisnuoli_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image14.png)
...
![nuolet_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image13.png)
Lopputulos voi olla esimerkiksi seuraavanlainen:
![lopputulos_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image10.png)
...
![tallenna_malliksi](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image26.png)
Lopputuloksen voit tulostaa tiedostoksi (kuvaksi tai pdf:ksi) tai tulostimeen. 
![tulostis_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image15.jpg)
...
TAI
- Lisää .../kurssihakemisto/HSY/Postinumeroalueet_2019.gpkg eli HSY:n postinumeroaineisto QGIS-projektiisi. Psst! Tämä aineisto on tallennettu koordinaattijärjestelmässä EPSG: 3067! 
...
Avaa uusi tuloste ja aseta sen sommittelu haluamaasi kokoon (esimerkiksi A5 tai käyttäjävalintainen). Lisää tulosteelle kartta, johon piirtyvät karttaikkunassa näkyvät projektin tasot. Lisää otsikko, selite ja muut karttatulosteen graafiset tai kartografiset elementit (kuten logo tai pohjoisnuoli) totuttuun tapaan.
Kannattaa lähentää karttanäkymä n. yhden postinumeroalueen laajuiseksi (esim. 1:25 000), sillä lopputuloksessa kartta-atlaksen karttalehdet automaattisesti kohdentuvat postinumeroialueiden kokoon.
...
![postinumeroalueet_taso_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image18.png)
...
![valitse_siirra2_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image3.png)
Muokkaamme kartta-atlasasetuksia oikean puolen sivupalkissa **Elementin ominaisuudet → Atlas ohjaa tätä**.
![atlas_ohjaa_tata_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image6.png)
Tämän jälkeen voimme esikatsella kartta-atlastamme **Esikatsele Atlasta -työkalulla** (käyttöliittymän ylhäällä oikealla):
![esikatsele_atlasta_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image4.jpg)
...
![yleiskatsaukset_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image12.png)
...
![vie_atlas_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image11.png)
...
![yhden_tiedoston_vienti](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image23.png)
Kartta-atlastuloste voisi näyttää esimerkiksi tältä:
![kartta-atlastuloste](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_5/image24.jpg)
