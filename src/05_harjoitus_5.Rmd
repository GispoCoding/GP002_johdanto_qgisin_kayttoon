...
![karttanakyma_tuloste_image](img/harjoitus_5/image1.png)
Vedä tulosalueelle suorakulmio, karttanäkymän mukainen kartta piirtyy näytölle.
![karttanakyma_image](img/harjoitus_5/image2.png)
...
![valitse_siirra_image](img/harjoitus_5/image16.png)
Valitse/siirrä elementtiä.


![siirra_sisaltoa_image](img/harjoitus_5/image21.png)
Siirrä elementin sisältöä (esimerkiksi kartan sisältöä).


![zoomaa_taiton_nakymassa_image](img/harjoitus_5/image19.png)
...
![lisaa_uusi_nimio_image](img/harjoitus_5/image7.png)
Lisää uusi selite käyttäen: 
![lisaa_uusi_selite_image](img/harjoitus_5/image8.png)
Ja lisää uusi mittakaava käyttäen: 
![lisaa_uusi_mittakaava_image](img/harjoitus_5/image20.png)
...
![tekstinmuokkaus_image](img/harjoitus_5/image25.png)
...
![phjoisnuoli_image](img/harjoitus_5/image14.png)
...
![nuolet_image](img/harjoitus_5/image13.png)
Lopputulos voi olla esimerkiksi seuraavanlainen:
![lopputulos_image](img/harjoitus_5/image10.png)
...
![tallenna_malliksi](img/harjoitus_5/image26.png)
Lopputuloksen voit tulostaa tiedostoksi (kuvaksi tai pdf:ksi) tai tulostimeen. 
![tulostis_image](img/harjoitus_5/image15.jpg)
...
![postinumeroalueet_taso_image](img/harjoitus_5/image18.png)
...
![yleiskatsaukset_image](img/harjoitus_5/image12.png)
...
![vie_atlas_image](img/harjoitus_5/image11.png)
...
![yhden_tiedoston_vienti](img/harjoitus_5/image23.png)
Kartta-atlastuloste voisi näyttää esimerkiksi tältä:
![kartta-atlastuloste](img/harjoitus_5/image24.jpg)
