...
![tasoluettelo_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image4.png)
...
![kuvaustekniikka_alamenu_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image12.png)
...
Lisätään nyt toinen vektorimuotoinen aineisto QGIS-projektiimme.
Käytä samaa työkalua kuin edellisessä harjoituksessa: avaa siis uusi taso painamalla **Lisää vektoritaso** -näppäintä. Etsi **.../kurssihakemisto/NaturalEarth/ne_10m_populated_places/** hakemistosta aineisto nimellä **ne_10m_populated_places_suomi.shp**. Tämä aineisto sisältää NaturalEarth-kaupunkiaineiston Suomesta.
...
![pistetaso_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image7.png)
...
![vari_ja_symbolit_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image1,png)
...
![rasterikuva_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image2.png)
...
![vari_ikkuna_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image5.png)
Avaa uudelleen tason **Properties-ikkuna**. **Kuvaustekniikka-asetuksista**, valitse ensin **Simple fill** oheisen kuvan mukaisesti:
![simple_fill_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image9.png)
...
![rasteritaso_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image3.png)
...
![tasokoordinaattijarjestelma_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image11.png)
...
![rasteritason_kuvaustekniikka_ikkuna_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_3/image8.png)
