...
Tarkastellaan nyt attribuutteja lähemmin **Tason ominaisuudet -ikkunassa**. 

Avaa juuri luomasi Alueet-tason **Tason ominaisuudet** -ikkuna ja valitse vasemmalta **Attribuutit**. Attribuutit-välilehdessä pystytään muokkaamaan attribuuttitaulun tietorakennetta. Aseta muokkaus päälle klikkaamalla kynäikonia. Uuden kentän pystyt lisäämään **Uusi kenttä -painikkeesta**, joka on varustettu keltaisella tähti-ikonilla. 
