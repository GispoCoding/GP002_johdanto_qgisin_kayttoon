...
Rastita vielä päälle **Yhdistä kytketyt viivat** välttääksesi kopioidut nimiöt (tämä löytyy Piirtäminen-alateeman Kohteen valinnat -kohdan alta).
...
Laita nyt näkyviin projektin rasterikuva **L4233B**. Se on Maanmittauslaitoksen avoin aineisto ja kyseinen aineisto sisältää osan  Helsingistä. Kun QGIS kysyy sen kordinaattijärjestelmätietoja, valitse **ETRS-TM35FIN**. Oletuksena korkeusmalli näyttää tällaiselta: 
