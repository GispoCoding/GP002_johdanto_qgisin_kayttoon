...
Avaa **NaturaKohde_ma-aineisto (.../kurssihakemisto/SYKE/Natura2000/)** uuteen projektiin. Avaa sitten **Ominaisuudet-ikkuna** ja valitse **Nimiöt-välilehti**.
...
![nimiot](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image11.png)
...
Teksti
Määritellään tekstin tyyli, väri ja muita yleisiä ominaisuuksia.
Muotoilu
Voit muodostaa useampirivisiä tekstejä, keskittää tekstiä ja määritellä lukujen muotoa.
Vyöhyke
Luodaan tekstiä korostavat puskurit (tekstin reunukset).
Tausta
Tekstin taustalle voi piirtää suorakulmion tai muun muodon.
Varjo
Teksteille voidaan muodostaa varjo.
Sijoittaminen
Määrittelee tekstien sijoittumista kohteiden suhteen.
Piirtäminen
Määrittelee tekstien mittakaavarajoja ja muita tekstien näkyvyyteen liittyviä asioita.

 
#### Nimiön tekstityyli
Nimiöiden tekstien tyyleille voit asettaa esimerkiksi haluamasi fontin, tyylin ja koon.
![tekstin_muotoilu_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image24.png)
...
![esimerkki_tekstista_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image8.png)
...
![vyohyke_alateema_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image5.png)
...
![sijoittaminen_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image19.png)
![nuuksio_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image10.png)
...
![sijoittaminen_prioriteetti_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image16.png)
...
![sijoittaminen_alateema](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image13.png)
...
Rastita vielä päälle **Yhdistä kytketyt viivat** välttääksesi kopioidut nimiöt (löytyy Piirtäminen-alateeman Kohteen valinnat -kohdan alta).
![kohteen_valinnat_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image2.png)
### Vektoriaineiston luokittelut 
Lisää **.../kurssihakemisto/HSY/Vaestotietoruudukko_2019.gpkg** eli HSY:n väestöruutuaineisto projektiisi. 
Se on vektoriaineisto, tällä kertaa kuitenkin geopackage-formaatissa. Voit lisätä sen projektiin **Tietolähteiden hallinta -työkalulla**.
Tutustu ensin aineistoon. Avaa **Attribuuttitaulu** painamalla aineistotason nimen päällä hiiren oikealla näppäimellä. Ominaisuustietojen ymmärtämiseksi on hyvä tarkastella taulun sisältöä sekä tutustua samalla aineiston metatietoihin (tietoa aineistosta). Metatiedot löytyvät usein aineistontuottajan nettisivuilta tai paikkatietojen löytämiseen tarkoitetuista hakemistoista. Metatiedot kertovat mm. ketä aineiston on tuottanut, mihin tarkoitukseen se on tehty, millä mittakaavalla ja missä koordinaattijärjestelmässä. 
...
![vaestoruudukko_pdf](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image25.png)
...
![aineisto_kartalla](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image18.png)
...
![suodatin_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image21.png)
...
![tason_ominaisuudet_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image3.png)
...
![tilastoteemakartta_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image7.png)
...
![luokat_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image17.png)
...
![histogrammi_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image22.png)

![symbolityyli_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image6.png)
...
![korkeusmalli_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image23.png)
Huomaa, että QGIS on tunnistanut, että aineisto sisältää jatkuvia arvoja ja on visualisoinut ne yksittäisenä harmaana kanavana. Oletusvärityksellä onnistut erottamaan Pasilan ratapihan. Zoomaa nyt Pasilan harmaana näkyvään alueeseen ja huomaa, että yksittäiset raiteet eivät erotu.
Avaa tason **Kuvaustekniikka-asetukset**, kuten aiemmin teit vektoriaineiston yhteydessä. Muista, että rasteriaineistojen kuvaustekniikkatyökalut ovat erilaiset kuin vektoriaineistoilla. Seuraavaksi luokitellaan aineisto uudelleen niin, että Pasilasta erottuu hienompia yksityiskohtia. Zoomaa tasaisen sävyisenä näkyvään ratapihan alueeseen. Klikkaa auki **Min/Max arvojen asetukset** ja muokkaa asetuksia niin, että kuva käyttää **Min/Max-arvoja** ja **Tilastojen laajuus -arvoksi** on määritelty **Nykyinen karttaikkuna**.
Katso mallia kuvasta:
![kuvaustekniikka-asetukset_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image14.png)

Paina sitten **Käytä**.
Kokeile myös mitä tapahtuu, jos vaihdat Tilastojen laajuudeksi **Päivitetty karttaikkuna**.
...
![tyokalu_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image15.png)
...
![mittakaavaperusteiden_nakyvyys_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image12.png)
...
![merkkijonoja_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image20.png)
...
![esimerkkiarvot_image](GP002_johdanto_qgisin_kayttoon/src/img/harjoitus_4/image1.png)
